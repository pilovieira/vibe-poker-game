...
- **Data Engine**: Firebase Realtime Database under the root path `vibe-poker` (players with embedded avatar, games, hall_of_fame), read directly by the browser with the Firebase JS SDK (`public/firebase.js`).
